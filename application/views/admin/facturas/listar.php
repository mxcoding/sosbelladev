<div class="container grande">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<ul class="nav nav-pills nav-stacked">
					<li class="active"><a href="<?php echo base_url('facturas');?>"><i class="icon-factura"></i> Facturas</a></li>
					<li><a href="<?php echo base_url('facturas/pagos');?>"><i class="icon-factura"></i> Pagos</a></li>
	...
	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
		<div class="panel panel-default">
			<div class="panel-body">
				<h3 class="text-center">Subir Factura</h3>
				<div class="row">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<span class="btn btn-default btn-file top btn-raised btn-sm">
							Seleccionar Archivos <i class="icon-pdf"></i> <input type="file" multiple>
						</span>
					</div>
				</div>
				<div class="row">
