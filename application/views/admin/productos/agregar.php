		...
		<div class="panel panel-default">
			<div class="panel-body">
				<ul class="nav nav-pills nav-stacked">
					...
					<li class="active"><a href="<?php echo base_url('productos/agregar');?>"><i class="icon-agregar"></i> Agregar</a></li>
				...
				<form id="frmAgregarEmpleado">
					...
					<div class="row" style="margin-top:20px;">
						<div class="col-lg-10 col-lg-offset-1 col-md-12 col-sm-12" style="background:#f3f3f3;">
							<div class="col-lg-4 col-md-4 col-sm-6">
								<div class="form-group">
									<label class="control-label azul" for="txtCantidad">Codigo</label>
							...
							<div class="col-lg-1" style="margin-top:1.8em;">
