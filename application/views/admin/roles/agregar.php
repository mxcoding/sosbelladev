<div class="container grande">
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<ul class="nav nav-pills nav-stacked">
					<li><a href="<?php echo base_url('roles');?>"><i class="icon-listar"></i> Consultar</a></li>
					<li class="active"><a href="<?php echo base_url('roles/agregar');?>"><i class="icon-agregar"></i> Agregar</a></li>
	...
	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-10">
		<div class="panel panel-default">
			<div class="panel-body">
				<h3 class="text-center">Agregar Rol</h3>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>¿Realmente desea eliminar el rol <strong id="clave_fra"></strong>?</p>
			</div>
